...
//         String formattedDate = this.date.getDayOfMonth() + "/" + this.date.getMonthValue() + "/" + this.date.getYear();
    ...
    public String details() {
        return
            ...
            "\nPoints awarded beyond the three-point arc: " + Regulation.INSIDE_THREE_POINT_ARC +
            "\nPoints awarded inside the three-point arc: " + Regulation.BEYOND_THREE_POINT_ARC +
